...
--project 719_v2_loss_ablation \
--name CocoAndVG_v2_loss_rank \
--model-name=$model \
...
--structure_ce_weight 0.0 \
--structure_batch_ce_weight 0.0 \
--structure_delta_l2_weight 0.0 \
--structure_delta_gap_weight 0.0 \
--structure_gate_tau 0.1 \
--structure_gate_max 0.3 \
--structure_gate_l1_weight 0.0 \
--structure_easy_gap 0.08 \
--structure_easy_gate_weight 0.0 \
...
--skip_topk_eval \
--eval_interval 1000 \
--save_path ./checkpoints/loss_ablation_rank.pt \
--device=cuda
